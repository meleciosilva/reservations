...
function SearchBar({ handleFind }) {  
  ...
  return (
    <div className="row d-flex justify-content-center">
      <form onSubmit={(event) => handleFind(event, phoneNumber)} className="col-xs-12 col-md-8 col-lg-6 pb-3">
        ...
        <div className="d-flex">
          ...
          <button type="submit" className="btn darkBackground lightText ml-1">Find</button>
        </div>
